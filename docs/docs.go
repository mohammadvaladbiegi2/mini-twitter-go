            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/timelinedto.TimelineResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/walletdto.BalanceRes"
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/walletdto.LedgerRes"
                        }
                    },
                    "401": {
                        "description": "Unauthorized, missing or invalid token",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/walletdto.RewardReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/walletdto.RewardRes"
                        }
                    },
                    "400": {
                        "description": "Validation failed (e.g. negative amount)",
                        "schema": {
                            "$ref": "#/definitions/apperror.AppError"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/walletdto.TransferReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/walletdto.TransferRes"
                        }
                    },
                    "400": {
                        "description": "Validation failed",
        ...
        "timelinedto.TimelineResponse": {
            ...
            "properties": {
                ...
                "tweets": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/timelinedto.Tweet"
                    }
                }
            }
        },
        ...
        "walletdto.LedgerRes": {
            ...
            "properties": {
                "entries": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/walletdto.LedgerEntry"
                    }
                },
                "total": {
                    "type": "integer",
